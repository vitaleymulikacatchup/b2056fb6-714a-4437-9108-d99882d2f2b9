...
export const metadata: Metadata = {
  title: "Ebash - Fine Dining Restaurant",
  description: "Experience culinary excellence at Ebash. Premium dining with signature dishes, exceptional service, and unforgettable moments.",
  keywords: "fine dining restaurant, gourmet cuisine, fine dining experience, upscale restaurant",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Ebash - Fine Dining Restaurant",
    description: "Discover culinary masterpieces at Ebash. Premium ingredients, artistic plating, and exceptional dining experiences.",
    type: "website",
    siteName: "Ebash"
  },
  twitter: {
    ...
    title: "Ebash - Fine Dining Restaurant",
    description: "Experience fine dining at its best. Reserve your table today."
  }
};
